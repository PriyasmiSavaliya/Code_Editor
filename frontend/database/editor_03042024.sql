...
--
-- Table structure for table `prectice`
--
...
--
-- Dumping data for table `prectice`
--

INSERT INTO `prectice` (`id`, `language`, `view`) VALUES
(1, 'php', 'php.pdf'),
(2, 'java', 'java.pdf');
...
--
-- AUTO_INCREMENT for table `prectice`
--
ALTER TABLE `prectice`
