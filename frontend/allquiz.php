...
<body class="dark">
    ...
    <section class="section-container-2">
        <div class="content-container-2">
            ...
            <a href="phpquiz.php"><button class="button">Start Quiz</button></a> 
            </div>
        </div>
        <img src="img/php.png" alt="Example Image">
    </section>
    <section class="section-container-1">
    <img src="img/c.png" alt="Example Image">
        <div class="content-container-1">
            ...
            <a href="cquiz.php"><button class="button">Start Quiz</button></a>
            </div>
        </div>
    </section>
    <section class="section-container-2">
        <div class="content-container-2">
            ...
            <div class="btn-container-2">
            <a href="pythonquiz.php"><button class="button">Start Quiz</button></a>
            </div>
        </div>
        <img src="img/python.png" alt="Example Image">
    </section>
    <section class="section-container-1">
    <img src="img/java.png" alt="Example Image">
        <div class="content-container-1">
            ...
            <div class="btn-container-1">
            <a href="javaquiz.php"><button class="button">Start Quiz</button></a>
            </div>
        </div>
    </section>
