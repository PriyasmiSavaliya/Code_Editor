...
$qry = "SELECT * FROM practice LIMIT $start_from, $records_per_page";
$data = mysqli_query($con, $qry);

// Count total number of records
$total_records_query = "SELECT COUNT(*) AS total FROM practice";
...
<div class="mx-auto bg-grey-400">
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <div class="flex flex-1">
            ...
            <div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
                        ...
                        <span class="heder">Practice Set</span>
                                ...
                                <table class="table-responsive w-full rounded">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="border px-3 py-2"><?php echo $result['prc_name'];?></td>
                                            <td class="border px-4 py-2"><?php echo $result['prc_lang'];?></td>
                                            <td class="border px-3 py-2"><p class="textwrap"><?php echo strip_tags($result['detail']);?></p></td>
    ...
    <div class="popup">
        <div class="popup-header header-popup">
            <h2>Practice Material Details</h2>
    ...
    <div class="user-data-box">
        <div class="user-data-table">
            ...
            <div class="user-data-row">
                <span class="label-popup detail-popup">Practice Name :</span>
                <span class="detail-popup"><?php echo $result['prc_name']; ?></span>
            </div>
            <div class="user-data-row">
                <span class="label-popup detail-popup">Practice Language :</span>
                <span class="detail-popup"><?php echo $result['prc_lang']; ?></span>
            </div>
            <div class="user-data-row">
                <span class="label-popup detail-popup">Practice Material :</span>
                <span class="detail-popup"><?php echo $result['prc_pdf']; ?></span>
            </div>
            <div class="user-data-row">
                <span class="label-popup detail-popup">Detail :</span>
                <span class="detail-popup"><?php echo $result['detail']; ?></span>
            </div>
            <div class="user-data-row">
