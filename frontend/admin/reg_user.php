...
$qry = "SELECT * FROM register LIMIT $start_from, $records_per_page";
                                ...
                                <table class="table-responsive w-full rounded">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="border px-3 py-2"><?php echo $result['fullname'];?></td>
                                            <td class="border px-4 py-2"><?php echo $result['email'];?></td>
                                            <td class="border px-4 py-2"><?php echo $result['mobile'];?></td>
                                            <td class="border px-4 py-2"><?php echo $result['city'];?></td>
                                            <td class="border px-4 py-2"><?php
                                            if($result['email'] == isset($data2['email'])){?>
                                                <p class="paid">Paid</p>
                                                <?php }else{ ?>
    ...
    <div class="user-data-box">
        <div class="user-data-table">
            ...
            <div class="user-data-row">
                ...
                <span class="detail-popup"><?php echo $result['fullname']; ?></span>
            </div>
            <div class="user-data-row">
                <span class="label-popup detail-popup">Mobile Number :</span>
                <span class="detail-popup"><?php echo $result['mobile']; ?></span>
            </div>
            <div class="user-data-row">
            ...
            <div class="user-data-row">
                <span class="label-popup detail-popup">Subscribed User :</span>
                <span class="detail-popup"><?php
                                            if($result['email'] == isset($data2['email'])){?>
                                                <p class="paid">Paid</p>
                                                <?php }else{ ?>
                                                <p class="unpaid">Unpaid</p>
