...
$qry = "SELECT * FROM tutorial LIMIT $start_from, $records_per_page";
$data = mysqli_query($con, $qry);

// Count total number of records
$total_records_query = "SELECT COUNT(*) AS total FROM tutorial";
...
<div class="mx-auto bg-grey-400">
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <div class="flex flex-1">
            ...
            <div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
                        ...
                        <span class="heder">Tutorials List</span>
                        <a class="bg-blue-500 hover:bg-blue-800 text-white font-bold py-2 px-4 border border-blue-800 rounded" href="add_tutorial.php">Add Topics</a>
                    </div>
                            <div class="p-3">
                                <table class="table-responsive w-full rounded">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="border px-3 py-2"><?php echo $result['topic_name'];?></td>
                                            <td class="border px-4 py-2"><p class="textwrap"><?php echo strip_tags($result['description']);?></p></td>
                                            ...
                                            <a class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white">
                                                ...
                                                <a class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white" href="edit_tutorial.php?tid=<?php echo $result['t_id']; ?>">
                                                        <i class="fas fa-edit"></i></a>
                                                <a class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-red-500" href="delete.php?tid=<?php echo $result['t_id']; ?>">
    ...
    <div class="user-data-box">
        <div class="user-data-table">
            ...
            <div class="user-data-row">
                <span class="label-popup detail-popup">Topic Name :</span>
                <span class="detail-popup"><?php echo $result['topic_name']; ?></span>
            </div>
            <div class="user-data-row">
                <span class="label-popup detail-popup">Tutorials Language :</span>
                <span class="detail-popup"><?php echo $result['language']; ?></span>
            </div>
            <!-- <div class="user-data-row">
                <span class="label-popup detail-popup">Topic Material :</span>
                <span class="detail-popup"><?php echo $result['t_code']; ?></span>
            </div> -->
            <div class="user-data-row">
                <span class="label-popup detail-popup">Description :</span>
                <span class="detail-popup"><?php echo $result['description']; ?></span>
            </div>
            <div class="user-data-row">
            ...
            <div class="btn-popup">
            <a class="border border-blue-800 rounded pubtn" href="edit_tutorial.php?tid=<?php echo $result['t_id']; ?>">Change Details</a>
            </div>
        </div>
    </div>
</div>
