    ...
    <div class="leading-loose">
      <form class="max-w-xl m-4 p-10 bg-white rounded shadow-xl" action="" method="post">
        ...
        <div class="mt-4 items-center justify-between">
          <button class="px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded" name="submit" id="submit">Login</button>
...
if(isset($_POST['submit'])){
  ...
  $sql = "SELECT * FROM user WHERE name = '$username' and passwd = '$password' and is_active='1'";
